  ...
  if (isJob) {
    return (
      ...
      <article className="group flex flex-row bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden items-center p-3 gap-5">
        ...
        <div className="relative h-24 w-32 md:h-28 md:w-40 flex-shrink-0 bg-slate-50 overflow-hidden rounded-xl">
          <img 
            src={cardImage} 
            alt={title}
        ...
        <div className="flex flex-col flex-grow min-w-0">
          ...
          <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-400 mt-3">
